...
def send_otp_email(user, purpose):
    ...
    if purpose == 'register':
        template_name = 'templates/emails/registration_email.html'
        subject = 'Bienvenue sur MISTRAL VOYAGE'
    elif purpose == 'login':
        template_name = 'templates/emails/login_email.html'
        subject = 'Connexion à votre compte MISTRAL VOYAGE'
    else:  # reset
        template_name = 'templates/emails/reset_password_email.html'
