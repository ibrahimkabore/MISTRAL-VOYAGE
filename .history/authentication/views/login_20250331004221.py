...
class LoginInitiateView(APIView):
    ...
    def post(self, request):
        """
        Cette fonctionnalité permet de lancer la procédure de connexion.
        Elle prend en paramètre un identifiant (nom d'utilisateur ou email) et un mot de passe.
        Si les informations sont valides, elle envoie un code OTP à l'utilisateur par email.
        """
