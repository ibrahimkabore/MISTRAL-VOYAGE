...
class VerifyEmailView(APIView):
    ...
    def post(self, request):
        try:
            email = request.data.get('email')  # Email envoyé automatiquement par le frontend
            code = request.data.get('code')    # Code saisi par l'utilisateur
            ...
            otp = OTPCode.objects.filter(email=email, purpose='register', code=code).order_by('-created_at').first()
