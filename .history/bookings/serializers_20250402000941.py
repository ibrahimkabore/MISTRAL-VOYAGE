...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = CustomUser
        fields = ['id', 'username', 'email', 'first_name', 'last_name', 'phone', 'gender', 'photos', 'currency', 'pays', 'ville']
        read_only_fields=['id']
...
class RegisterSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = CustomUser
        fields = ['email', 'first_name', 'last_name', 'phone', 'gender', 'photos', 'password', 'password2']
        read_only_fields=['id']
