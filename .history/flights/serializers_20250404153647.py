...
class FlightSearchSerializer(serializers.Serializer):
    origins = serializers.ListField(child=serializers.CharField(max_length=3), min_length=1)
    destinations = serializers.ListField(child=serializers.CharField(max_length=3), min_length=1)
