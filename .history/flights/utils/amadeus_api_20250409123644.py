        ...
        try:
            ...
            request_data = {
                "data": {
                    ...
                    "travelers": travelers,  # Inclure travelers directement dans le body
                    "contacts": [contact] if not isinstance(contact, list) else contact
                }
            }
            
            # Appel à l'API Amadeus avec le body complet
            response = self.client.booking.flight_orders.post(body=request_data)
