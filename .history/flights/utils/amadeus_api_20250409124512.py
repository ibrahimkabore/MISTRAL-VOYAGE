...
class AmadeusAPI:
    ...
    def create_flight_order(self, flight_offers, travelers, contact):
        ...
        try:
            ...
            # Appel à l'API Amadeus - la méthode post() s'attend à recevoir deux arguments distincts
            # 1. Le premier argument est l'objet flight_order_data
            # 2. Le second argument est spécifiquement travelers
            response = self.client.booking.flight_orders.post(flight_order_data, travelers)
