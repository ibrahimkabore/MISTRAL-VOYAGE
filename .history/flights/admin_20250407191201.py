...
class FlightOfferAdmin(admin.ModelAdmin):
    list_display = ( 'origin', 'destination', 'departure_date', 'arrival_date', 'price', 'airline', 'is_round_trip', 'available_seats', 'created_at')
    search_fields = ( 'origin__code', 'destination__code', 'airline', 'flight_number')
